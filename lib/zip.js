...
ZipDirectoryEntry.prototype.entrySync = function () {
  ...
  var _entry = new ZipEntry(this, null, entry_header_buff, file_name_buff, extra_field_buff);
...
function ZipEntry(central, file, header, entryName, extraField) {
...
Object.defineProperties(ZipEntry.prototype, {
  ...
  readFileSync: {
    value: function (options) {
      ...
      var file = this.file.sub(this.headerSize, this.headerSize + this.central.compressedSize)
      file.readStreamSync(_ondata);
      if (this.compressionMethod === 8) {
        return inflateRawSync(Buffer.concat(buffers))//, options)));
      }
