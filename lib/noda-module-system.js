...
exports.createNodaModuleSystem = function createNodaModuleSystem(archive_path, handle_or_path, builtin_overrides) {
   ...
   var builtins = {
      ...
      buffer: {exports:require('buffer'),chidren:[]},
      http: {exports:require('http'),chidren:[]},
      util: {exports:require('util'),chidren:[]},
      stream: {exports:require('stream'),chidren:[]},
      querystring: {exports:require('querystring'),chidren:[]},
      child_process: {exports:require('child_process'),chidren:[]},
      os: {exports:require('os'),chidren:[]},
      vm: {exports:require('vm'),chidren:[]},
      readline: {exports:require('readline'),chidren:[]},
      repl: {exports:require('repl'),chidren:[]},
      dgram: {exports:require('dgram'),chidren:[]},
      string_decoder: {exports:require('string_decoder'),chidren:[]},
      dns: {exports:require('dns'),chidren:[]},
      zlib: {exports:require('zlib'),chidren:[]},
      constants: {exports:require('constants'),chidren:[]},
      https: {exports:require('https'),chidren:[]},
      crypto: {exports:require('crypto'),chidren:[]},
      tls: {exports:require('tls'),chidren:[]},
      events: {exports:require('events'),chidren:[]},
      assert: {exports:require('assert'),chidren:[]},
      path: {exports:require('path'),chidren:[]},
      fs: {exports:require('fs'),chidren:[]},
      url: {exports:require('url'),chidren:[]},
      tty: {exports:require('tty'),chidren:[]},
      smalloc: {exports:require('smalloc'),chidren:[]},
   };
